module.exports = {
  ...
  trailingComma: 'es5', // Print trailing commas wherever possible in multi-line comma-separated syntactic structures. (e.g. arrays, objects)
  ...
  endOfLine: 'lf', // Ensure consistent line endings (Linux/macOS style).
};
